...
def D_Base(request, number):
    platoon = Platoon.objects.get(number=number)
    return render_to_response('Documents/base.html', {"platoon": platoon}, context_instance=RequestContext(request))
